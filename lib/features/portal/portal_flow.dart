...
class PortalHeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: glassDecorationFor(context, radius: 28),
      child: Column(
        children: [
          SizedBox(
            width: 132,
          ...
          SizedBox(
            ...
            height: 64,
            child: DecoratedBox(
              decoration: primaryButtonDecorationFor(context, radius: 16),
              child: TextButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 36,
                      decoration: BoxDecoration(
                        color: palette.dark ? palette.onPrimary : Colors.white,
