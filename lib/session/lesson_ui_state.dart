...
class LessonUiState extends ChangeNotifier {
  ...
  bool accountDeletionLoading = false;
  ...
  void beginAccountDeletionRequest() {
    accountDeletionLoading = true;
    accountDeletionMessage = 'Registrando solicitacao no servidor...';
    notifyListeners();
  }

  void completeAccountDeletionRequest() {
    accountDeletionLoading = false;
    accountDeletionMessage =
        'Exclusao concluida. Seus dados pessoais de aula foram removidos do servidor.';
    notifyListeners();
  }

  void failAccountDeletionRequest(String message) {
    accountDeletionLoading = false;
