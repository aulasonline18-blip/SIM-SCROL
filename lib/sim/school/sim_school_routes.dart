...
const simLiveRoutes = <SimSchoolRoute>[
  ...
  SimSchoolRoute(
    path: '/login',
    kind: SimRouteKind.screen,
    environmentId: 'login',
  ),
  SimSchoolRoute(
    path: '/cyber/idioma',
    kind: SimRouteKind.screen,
    environmentId: 'language',
  ),
  SimSchoolRoute(
    path: '/cyber/objeto',
    kind: SimRouteKind.screen,
    environmentId: 'objective',
  ),
  SimSchoolRoute(
    path: '/cyber/curriculo',
    kind: SimRouteKind.screen,
    environmentId: 'preparation',
  ),
  SimSchoolRoute(
    path: '/cyber/placement',
    kind: SimRouteKind.screen,
    environmentId: 'placement',
  ),
  SimSchoolRoute(
    path: '/cyber/warmup',
    kind: SimRouteKind.screen,
    environmentId: 'warmup',
  ),
  SimSchoolRoute(
    path: '/cyber/aula',
    kind: SimRouteKind.screen,
  ...
  SimSchoolRoute(
    path: '/creditos',
    kind: SimRouteKind.screen,
    environmentId: 'credits',
  ),
  SimSchoolRoute(
    path: '/checkout/return',
    kind: SimRouteKind.screen,
    environmentId: 'checkout_return',
  ),
  SimSchoolRoute(
    path: '/pai',
    kind: SimRouteKind.screen,
    environmentId: 'father_panel',
  ),
  SimSchoolRoute(
    path: '/privacidade',
    kind: SimRouteKind.screen,
    environmentId: 'privacy',
  ),
  SimSchoolRoute(
    path: '/termos',
    kind: SimRouteKind.screen,
