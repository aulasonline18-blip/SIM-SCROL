...
String? renderKinematicsVT(Map<String, dynamic> p) {
  ...
  final p0x = s.toX(0);
  final p0y = s.toY(v0);
  final pFx = s.toX(tMax);
  final pFy = s.toY(vFinal);
  ...
  body.write(
    '<line x1="${p0x.toStringAsFixed(2)}" y1="${p0y.toStringAsFixed(2)}" x2="${pFx.toStringAsFixed(2)}" y2="${pFy.toStringAsFixed(2)}" stroke="$lineColor" stroke-width="3" stroke-linecap="round"/>',
  );
