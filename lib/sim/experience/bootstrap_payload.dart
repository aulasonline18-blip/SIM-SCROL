...
JsonMap buildT00Phase1Body({
  ...
  return {
    'ficha': {
      ...
      'language': data['learningLocale'] ?? lang,
      ...
      'learningLocale': data['learningLocale'],
      'explanationLanguage': data['explanationLanguage'],
      'targetLanguage': data['targetLanguage'],
      'mediaTextLanguage': data['mediaTextLanguage'],
      'localeContract': data['localeContract'],
      'pedagogical_entry': data['pedagogical_entry'],
      'pedagogical_entry_ficha': data['pedagogical_entry_ficha'],
      'human_summary_locale': data['human_summary_locale'],
      'student_profile_notes_locale': data['student_profile_notes_locale'],
      ...
      'goal_type_source': data['goal_type_source'],
