...
class T00ProfileEvent {
  const T00ProfileEvent({this.profile, this.fichaForNext});
...
JsonMap? persistT00ProfileEvent({
  ...
  final patch = <String, dynamic>{
    ...
    'student_profile_internal': {'source': 'T00', 'profile': profile},
    ...
    'interpreted_fields': {...interpreted, 't00_profile': profile},
  };
  _writeProfilePatch(service, lessonLocalId, patch);
  return {...data, ...patch};
}
