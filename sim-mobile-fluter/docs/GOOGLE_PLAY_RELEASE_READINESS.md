...
Status desta frente: configuracao Android basica pronta no repositorio.
...
- Observacao: este package foi restaurado temporariamente para atualizar por
  ...
  voltar para o package oficial planejado `com.smarttutorbr.sim`, com migracao
  consciente de dados/identidade.
- App label: `SIM`
...
- Definir dominio HTTPS publico para API (`SIM_SERVER_URL`).
